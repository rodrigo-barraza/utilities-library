...
export declare const CORE_AGENTIC_TOOLS: readonly ["upsert_memory", "create_task", "list_tasks", "update_task", "calculate_precise", "execute_javascript", "execute_python", "search_tools", "search_web", "read_url", "get_web_content", "enter_plan_mode", "exit_plan_mode", "ask_user_question", "write_todo", "brief", "enter_worktree", "exit_worktree", "create_skill", "execute_skill", "list_skills", "delete_skill"];
