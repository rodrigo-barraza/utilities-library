...
export const CAPABILITY_DISPLAY_NAMES: Record<string, string> = Object.fromEntries(byName.map((c) => [c.name, c.name]));
export const CAPABILITY_SHORT_NAMES: Record<string, string> = Object.fromEntries(byName.map((c) => [c.name, c.short]));
export const CAPABILITY_EMOJI: Record<string, string> = Object.fromEntries(byName.map((c) => [c.name, c.emoji]));
export const CAPABILITY_COLORS: Record<string, string> = Object.fromEntries(byName.map((c) => [c.name, c.color]));
 ...
 */
export function resolveCapability(nameOrAlias: string): CapabilityMeta | undefined {
...
export function resolveCapabilityName(nameOrAlias: string): string {
